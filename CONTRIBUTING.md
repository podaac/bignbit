# Contributing to bignbit

Thank you for contributing to bignbit!
...
The easiest way to get help or ask a question regarding bignbit is in 
the EOSDIS Slack #harmony-bignbit channel, or by asking a question 
...
of bignbit that produced this bug and specific error messages.
...
bignbit maintains a [changelog](CHANGELOG.md). See 
...
bignbit follows PEP8 as much as possible. Reference the [pylint](.pylintrc) and 
...
bignbit uses [Numpy docstrings](https://numpydoc.readthedocs.io/en/latest/format.html). 
