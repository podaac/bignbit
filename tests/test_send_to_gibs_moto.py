...
def test_process_sends_message(fake_response_sqs_queue, mock_gitc_success, cnm_v151_schema, monkeypatch):
    ...
    assert gibs_cnm['identifier'] == '20210102090000-JPL-L4_GHRSST-SSTfnd-MUR-GLOB-v02.0-fv04.1_analysed_sst_regridded_subsetted_2021002_EPSG:4326!G1240565717-POCUMULUS'
