...
# This script is intended to be run by the CI/CD pipeline to build a specific version of an app
...
# Build the image
docker build -f ./docker/Dockerfile -t "${repositoryName}":"${dockerTagVersion}" .
